...
Welcome to the Giskard Python API documentation. Giskard is a framework for robot motion planning and control based on constraint-based optimization.
...
To get started with Giskard, please refer to the [User Guide](user_guide.md).
